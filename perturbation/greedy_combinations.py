...
from utils import calculate_results, calculate_similarity, get_config
import pandas as pd
import numpy as np
import argparse
...
def greedy_combination(config):
    ...
    df = pd.DataFrame(data={"selected_perturbations": SELECTED_PERTURBATION_RECORD, "BEST_THRESHOLDS": BEST_THRESHOLD_RECORD, 
                            "MAX_ACCS": MAX_ACC_RECORD, "TEST_FPR": TEST_FPR_RECORD, "TEST_FNR": TEST_FNR_RECORD,
