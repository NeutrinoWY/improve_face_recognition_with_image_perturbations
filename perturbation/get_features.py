...
def main():
    ...
    #perturb_No, scales, angles, shifts = [0] * n, [0] * n, [0] * n, [0] * n
    ...
    for index, item in enumerate(perturbation_spaces):
        ...
        preprocessor = PerturbTransformer(scale_param=item[0], angle_param=item[1], shift_param=item[2:])
