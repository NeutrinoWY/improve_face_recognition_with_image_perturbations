...
class AFFFE(TransformerMixin, BaseEstimator):
    ...
    def __init__(self):
        self.config = config
        self.MainModel = imp.load_source('MainModel', "/Users/yunwang/AFFACT+AFFFE/perturbation_ldmk/model/AFFFE_model.py")
        self.network = torch.load("/Users/yunwang/AFFACT+AFFFE/perturbation_ldmk/model/AFFFE.pth")
...
class MyExtractor(TransformerMixin, BaseEstimator):
    ...
    def __init__(self, config):
        ...
        self.network = resnet51(pretrained=0, progress=False, feature_size=512,
                            num_classes=8631)
        self.checkpoint = torch.load(config.load_model.checkpoint) #"/Users/yunwang/AFFACT+AFFFE/perturbation_1/model/best_checkpoint.pth")
