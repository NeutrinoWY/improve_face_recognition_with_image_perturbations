...
class AffactTransformer():
    ...
    def __call__(self, sample):
        ...
        # if random jitter is disabled, scale parameter is equal to the scale parameter of validation transformer
        else:
        ...
        # Apply gamma for contrast, not part of the AFFACT paper
        ...
        #print(to_tensor(placeholder_out).shape)
